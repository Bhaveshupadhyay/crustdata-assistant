...
async def main():
    ...
    await assistant.answer_question(
        "Hi, I prefer python code and my API key is xyz123", conversation_id=session_id
    )
    ...
    response = await assistant.answer_question(
        "how do i search for the job data? i need a code in java", conversation_id=session_id
    )
